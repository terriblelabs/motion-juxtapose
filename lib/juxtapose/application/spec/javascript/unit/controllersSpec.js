(function() {
  ...
  describe('ProjectsCtrl', function() {
    ...
    it('should extract the iOS version', function() {
      var spec = { directory: "/Code/screenshotter-test/spec/screens/ios_7.0.3/home-controller-has-a-single-button/home_screen" }
      expect(test.scope.iOSVersion(spec)).toEqual("7.0.3")

      spec = { directory: "/Code/screenshotter-test/spec/screens/7.0/home-controller-has-a-single-button/home_screen" }
      expect(test.scope.iOSVersion(spec)).toEqual("7.0")
    })

    return it('should extract the spec name', function() {
      var spec = { directory: "/Code/screenshotter-test/spec/screens/ios_7.0.3/home-controller-has-a-single-button/home_screen" }
      expect(test.scope.specName(spec)).toEqual("Home controller has a single button")
    })
  })
